...
namespace LightingAndCamerasStarter
{
    ...
    public class Crate
    {
        ...
        void InitializeEffect()
        {
            ...
            effect.DirectionalLight0.SpecularColor = new Vector3(0f, 0.4f, 0.4f);

            //Set up light 1
            effect.DirectionalLight1.Enabled = true;
            effect.DirectionalLight1.Direction = new Vector3(0f, -1f, 0f);
            effect.DirectionalLight1.DiffuseColor = new Vector3(0.8f, 0, 0);
            effect.DirectionalLight1.SpecularColor = new Vector3(0f, 0.4f, 0.4f);
